...
class MapsTest extends PHPUnit_Framework_TestCase
{
    public function callbackDataProvider()
    {
        return [
            ...
            ['reduce implode', Maps::reduce(Reductions::implode(','), ''), '', []],
            ['reduce implode', Maps::reduce(Reductions::implode(',')), ',,', ['', '', '']],
            ['reduce implode', Maps::reduce(Reductions::implode(',', null, false)), ',,,', ['', '', '']],
            ['reduce implode', Maps::reduce(Reductions::implode(','), ''), ',,,', ['', '', '']],
            ...
            ['reduce sum', Maps::reduce(Reductions::sum(), 13), 13, []],
            ['reduce sum', Maps::reduce(Reductions::sum(), 0), 0, [5, -5]],
            ['reduce sum', Maps::reduce(Reductions::sum(), 0), 10, [5, -10, 15]],
            ['reduce product', Maps::reduce(Reductions::product()), 6, [1, 2, 3]],
            ['reduce product', Maps::reduce(Reductions::product(), 1), 1, []],
            ['reduce product', Maps::reduce(Reductions::product(), 13), 13, []],
            ['reduce product', Maps::reduce(Reductions::product()), -25, [5, -5]],
            ['reduce product', Maps::reduce(Reductions::product()), -750, [5, -10, 15]],
            ['reduce product', Maps::reduce(Reductions::product(null, false)), 0, [5, -10, 15]],
            ['reduce ands', Maps::reduce(Reductions::ands(), true), true, []],
            ['reduce ands', Maps::reduce(Reductions::ands(), false), false, []],
            ['reduce ands', Maps::reduce(Reductions::ands()), true, [true]],
            ['reduce ands', Maps::reduce(Reductions::ands(null, false)), false, [true]],
            ...
            ['reduce ands', Maps::reduce(Reductions::ands(), true), false, [true, true, false]],
            ['reduce ors', Maps::reduce(Reductions::ors()), false, []],
            ...
            ['reduce ors', Maps::reduce(Reductions::ors()), true, [true, false, true]],
            ['reduce ors', Maps::reduce(Reductions::ors()), true, [false, true, true]],
            ['reduce ors', Maps::reduce(Reductions::ors()), false, [false, false, false]],
            ['reduce max', Maps::reduce(Reductions::max()), null, []],
            ['reduce max', Maps::reduce(Reductions::max()), 0, [0]],
            ['reduce max', Maps::reduce(Reductions::max()), 99, [0, 10, 99, -99]],
            ['reduce min', Maps::reduce(Reductions::min()), null, []],
            ['reduce min', Maps::reduce(Reductions::min()), 0, [0]],
            ['reduce min', Maps::reduce(Reductions::min()), -99, [0, 10, 99, -99]],
            ['reduce average', Maps::reduce(Reductions::average()), 0, []],
            ['reduce average', Maps::reduce(Reductions::average(), 10), 10, []],
            ['reduce average', Maps::reduce(Reductions::average(), 10), 5, [0]],
            ['reduce average', Maps::reduce(Reductions::average()), 2.5, [0, 10, 99, -99]],
            ['reduce average', Maps::reduce(Reductions::average(), 5), 3, [0, 10, 99, -99]],
        ];
    }
